...
export default class BookRequestScreen extends Component{
  ...
  addRequest = async (bookName,reasonToRequest)=>{
    ...
    var books=await BookSearch.searchbook(bookName,'AIzaSyBKTk0vQQ5FonLxqOmjCl1YcOhEDcA19TM')
...
renderItem=({item,i})=>{
  let Obj={title:item.volumeInfo.title,
  ...
  return(
    <TouchableHighlight 
    style={{alignItems:'center',backgroundColor:'#ddeddd',padding:10,width:'90%'}}
    onPress={()=>{
...
<Text>{item.volumeInfo.title}</Text>
  ...
  render(){
    ...
    return(
      // Form screen
        <View style={{flex:1}}>
          <MyHeader title="Sell" navigation ={this.props.navigation}/>
